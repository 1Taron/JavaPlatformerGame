...
public class HelpMethods {
	...
	public static boolean JIsProjectileHittingLevel(J_Projectile jp, int[][] lvlData) {
		return IsSolid(jp.getHitbox().x + jp.getHitbox().width / 2, jp.getHitbox().y + jp.getHitbox().height / 2, lvlData);
	}
