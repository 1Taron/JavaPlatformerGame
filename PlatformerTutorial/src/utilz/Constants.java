...
public class Constants {
	...
	public static class ObjectConstants {
		...
		public static final int JUR_CANNON_LEFT = 10;
		public static final int JUR_CANNON_RIGHT = 11;
		...
		public static int GetSpriteAmount(int object_type) {
			...
			case BARREL, BOX:
				return 8;
			case CANNON_LEFT, CANNON_RIGHT, JUR_CANNON_LEFT, JUR_CANNON_RIGHT:
				return 7;
			}
			return 1;
		}
	...
	public static class MagicConstants{
		public static final int MAGIC_CAST_WIDTH_DEFAULT = 96;
		public static final int MAGIC_CAST_HEIGHT_DEFAULT = 96;
		public static final int MAGIC_CLOW_WIDTH_DEFAULT = 96;
		public static final int MAGIC_CLOW_HEIGHT_DEFAULT = 96;

		public static final int MAGIC_CAST_WIDTH = (int) (Game.SCALE * MAGIC_CAST_WIDTH_DEFAULT);
		public static final int MAGIC_CAST_HEIGHT = (int) (Game.SCALE * MAGIC_CAST_HEIGHT_DEFAULT);
		public static final int MAGIC_CLOW_WIDTH = (int) (Game.SCALE * MAGIC_CLOW_WIDTH_DEFAULT);
		public static final int MAGIC_CLOW_HEIGHT = (int) (Game.SCALE * MAGIC_CLOW_HEIGHT_DEFAULT);
//		public static final float SPEED = 0.75f * Game.SCALE;
	}
	...
	public static class EnemyConstants {
		...
		// JUR
		public static final int JUR_SKULL = 25;
		public static final int JUR_SKULL_WIDTH_DEFAULT = 260;
		public static final int JUR_SKULL_HEIGHT_DEFAULT = 402;
		public static final int JUR_SKULL_WIDTH = (int) (JUR_SKULL_WIDTH_DEFAULT * Game.SCALE);
		public static final int JUR_SKULL_HEIGHT = (int) (JUR_SKULL_HEIGHT_DEFAULT * Game.SCALE);
		public static final int JUR_SKULL_DRAWOFFSET_X = (int) (1 * Game.SCALE);
		public static final int JUR_SKULL_DRAWOFFSET_Y = (int) (1 * Game.SCALE);

		public static int GetSpriteAmount(int enemy_type, int enemy_state) {
			switch (enemy_state) {

			case IDLE: {
				if (enemy_type == CRABBY || enemy_type == JUR_SKULL)
					return 9;
				else if (enemy_type == PINKSTAR || enemy_type == SHARK)
					return 8;
			}
			case RUNNING:
				if (enemy_type == JUR_SKULL)
					return 9;
				return 6;
			case ATTACK:
				if (enemy_type == SHARK)
					return 8;
				else if (enemy_type == JUR_SKULL)
					return 9;
				return 7;
			case HIT:
				if (enemy_type == JUR_SKULL)
