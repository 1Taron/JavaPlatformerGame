...
public class Level {
	...
	private ArrayList<JUR_Skull> jskull = new ArrayList<>();
	private ArrayList<J_Cannon> jcannons = new ArrayList<>();
	...
	private void loadEntities(int greenValue, int x, int y) {
		...
		//JUR
		case JUR_SKULL -> jskull.add(new JUR_Skull(x * Game.TILES_SIZE, y * Game.TILES_SIZE));
	...
	private void loadObjects(int blueValue, int x, int y) {
		...
		case JUR_CANNON_LEFT, JUR_CANNON_RIGHT -> jcannons.add(new J_Cannon(x * Game.TILES_SIZE, y * Game.TILES_SIZE, blueValue));
	...
	public ArrayList<J_Cannon> getJCannons() {
		return jcannons;
	}
	...
	public ArrayList<JUR_Skull> getJURSkull() {
		return jskull;
	}
